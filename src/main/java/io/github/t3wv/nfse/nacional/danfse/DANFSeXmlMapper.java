...
final class DANFSeXmlMapper {
    ...
    private static BufferedImage qrImage(String content) throws Exception {
    ...
    private static Dados parse(String xml) throws Exception {
    ...
    private static String money(String v) {
        ...
        try {
            return MONEY_FMT.format(Double.parseDouble(v));
        } catch (Exception e) {
            return v;
        }
    }
