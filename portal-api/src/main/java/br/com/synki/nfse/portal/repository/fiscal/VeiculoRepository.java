...
public interface VeiculoRepository extends JpaRepository<Veiculo, Long> {
    List<Veiculo> findByEmpresaIdAndAtivoTrueOrderByPlacaAsc(Long empresaId, Pageable pageable);

    List<Veiculo> findByEmpresaIdOrderByPlacaAsc(Long empresaId, Pageable pageable);
